...
const FAST_OVERRIDES = Object.fromEntries(MODES.map((m) => [m.id, narrowResolutionToFast] as const));
...
export const SEEDANCE_VOLCENGINE_ARCHETYPE: ModelArchetype = {
  ...
  variants: [
    ...
    { id: "fast", label: "快速", modelKey: "doubao-seedance-2-0-fast-260128", paramOverrides: FAST_OVERRIDES },
  ],
